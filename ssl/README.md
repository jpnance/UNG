...
The runt uses [mkcert](https://github.com/FiloSottile/mkcert) to generate locally-trusted certificates. It creates `untitled-key.pem` and `untitled.pem` for `untitled.coinflipper.local`.
